...
## Triggers
- **Order Confirmation**: When a new order for any of the 5 connected stores (Order ID prefix maps to brand) comes into Notion with status `CONFIRMED | PROCESSING`, a brand-specific WhatsApp template is sent to the customer.
...
```env
WHATCHIMP_API_TOKEN=your_whatchimp_api_token_here
