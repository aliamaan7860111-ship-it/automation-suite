...
class TestBuildPayload(unittest.TestCase):
    def _full_order(self):
        return {
            ...
            "phone": "0500000000",
            "full_address": "Apt 1 Test Tower Silicon Oasis Dubai",
            "total": 295.00,
            "item_qty": "Test Item  1",
            "internal_note": "",
        }
    ...
    def test_valid_order_builds_payload(self):
        ...
        self.assertEqual(result["RecipientName"], "Test Customer")
        self.assertEqual(result["TotalCOG"], "295.00")
        self.assertEqual(result["MobileNumber"], "0500000000")
...
class TestBuildMergedPayload(unittest.TestCase):
    def _order(self, order_id, total, item):
        return {
            ...
            "customer_name": "Test Customer",
            "phone": "0500000000",
            "full_address": "Test Address 1, Dubai",
            "total": total,
            "item_qty": item,
            "internal_note": "",
        }
