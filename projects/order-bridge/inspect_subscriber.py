...
Usage:
    python execution/inspect_subscriber.py 971500000000
    python execution/inspect_subscriber.py +971 50 000 0000
    python execution/inspect_subscriber.py 0500000000
"""
import sys
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Example: python execution/inspect_subscriber.py 971500000000")
        sys.exit(1)
