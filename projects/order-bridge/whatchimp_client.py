...
#
# NOTE: Real WhatChimp IDs and phone numbers redacted for the public showcase.
# In the live deployment these are loaded from .env (see .env.example).
BRAND_CONFIG = {
    "PT": {  # Brand 1
        "phone_number_id":   os.getenv("WC_PT_PHONE_ID", ""),
        "template_id":       os.getenv("WC_PT_TEMPLATE_ID", ""),
        "confirm_button_qr": os.getenv("WC_PT_QR", ""),
        "brand_display":     "Brand 1",
        "sender_phone":      os.getenv("WC_PT_SENDER", ""),
    },
    "Di": {  # Brand 2
        "phone_number_id":   os.getenv("WC_DI_PHONE_ID", ""),
        "template_id":       os.getenv("WC_DI_TEMPLATE_ID", ""),
        "confirm_button_qr": os.getenv("WC_DI_QR", ""),
        "brand_display":     "Brand 2",
        "sender_phone":      os.getenv("WC_DI_SENDER", ""),
    },
    "LU": {  # Brand 3
        "phone_number_id":   os.getenv("WC_LU_PHONE_ID", ""),
        "template_id":       os.getenv("WC_LU_TEMPLATE_ID", ""),
        "confirm_button_qr": os.getenv("WC_LU_QR", ""),
        "brand_display":     "Brand 3",
        "sender_phone":      os.getenv("WC_LU_SENDER", ""),
    },
    "VX": {  # Brand 4
        "phone_number_id":   os.getenv("WC_VX_PHONE_ID", ""),
        "template_id":       os.getenv("WC_VX_TEMPLATE_ID", ""),
        "confirm_button_qr": os.getenv("WC_VX_QR", ""),
        "brand_display":     "Brand 4",
        "sender_phone":      os.getenv("WC_VX_SENDER", ""),
    },
    "AM": {  # Brand 5
        "phone_number_id":   os.getenv("WC_AM_PHONE_ID", ""),
        "template_id":       os.getenv("WC_AM_TEMPLATE_ID", ""),
        "confirm_button_qr": os.getenv("WC_AM_QR", ""),
        "brand_display":     "Brand 5",
        "sender_phone":      os.getenv("WC_AM_SENDER", ""),
    },
}

# Fallback for legacy call paths (PT is the original sender number).
...
def get_brand_config(order_id_or_prefix: str) -> dict:
    """Look up the brand config from an order_id or its 2-char prefix. Defaults to PT."""
...
def get_subscriber_custom_fields(
    ...
    Response custom_fields format: "brand_name:Brand 1,order_id:PT1793"
    """
    cleaned_phone = clean_phone_number(phone_number)
