...
# ---------------------------------------------------------------------------
# Brand names redacted for public showcase. Live config maps order_id prefixes
# to real brand names; here we use generic labels.
BRAND_MAP = {
    "PT": "Brand 1",
    "AM": "Brand 5",
    "VX": "Brand 4",
...
def get_brand_from_order_id(order_id: str) -> str:
    ...
    if not isinstance(order_id, str):
        return "Brand 1"
    prefix = order_id[:2]
    return BRAND_MAP.get(prefix, "Brand 1")
