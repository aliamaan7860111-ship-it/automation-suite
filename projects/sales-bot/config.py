...
STORE_CONFIG = {
    os.getenv("WHATCHIMP_PHONE_NUMBER_ID", "default"): {
        "store": os.getenv("DEFAULT_STORE", "store_a"),
        "currency": os.getenv("STORE_CURRENCY", "AED"),
        "name": os.getenv("STORE_NAME", "Store A"),
        "human_label_id": os.getenv("WHATCHIMP_HUMAN_LABEL_ID", ""),
        "phone_number_id": os.getenv("WHATCHIMP_PHONE_NUMBER_ID", ""),
    },
    # Add more stores by mapping each WhatChimp phone_number_id → store config.
    # "phone_id_2": {
    #     "store": "store_b",
    #     "currency": "AED",
    #     "name": "Store B",
    #     "human_label_id": "<label_id>",
