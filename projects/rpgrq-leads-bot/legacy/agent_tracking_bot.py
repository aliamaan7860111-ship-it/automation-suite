...
# Brand identifiers redacted for public showcase. In live deployment these
# are loaded from .env (BRAND_PHONE_MAP_JSON).
import json as _json
PHONE_BRANDS = _json.loads(os.getenv("BRAND_PHONE_MAP_JSON", "{}"))

API_BASE = "https://app.whatchimp.com/api/v1/whatsapp"
POLL_INTERVAL_SECONDS = 15

# Known Human Agents (loaded from env in live deployment)
AGENTS = _json.loads(os.getenv("AGENTS_JSON", '["Agent A", "Agent B", "Agent C"]'))
