...
# Webhook payloads send whatsapp_bot_name in TitleCase (e.g. "Brand Name"),
# so we normalize via this alias map.
# Brand identifiers (phone_number_id, bot_id) redacted for public showcase.
# In live deployment these are loaded from .env as JSON strings.
BRAND_BY_PHONE_ID = json.loads(os.getenv("BRAND_PHONE_MAP_JSON", "{}"))
