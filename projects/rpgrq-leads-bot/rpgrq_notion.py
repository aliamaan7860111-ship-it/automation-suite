...
Two databases (IDs loaded from .env):
  - LEADS_DB_ID  - CRM tickets
  - ROSTER_DB_ID - agents, IDs, shifts
...
LEADS_DB_ID    = os.getenv("LEADS_DB_ID", "").strip()
ROSTER_DB_ID   = os.getenv("ROSTER_DB_ID", "").strip()
