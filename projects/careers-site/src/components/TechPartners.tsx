...
export function TechPartners() {
    ...
    return (
        <section className="w-full overflow-hidden py-8 relative group">
            {/* Fade Out Edges — match exact page bg */}
            <div className="absolute inset-y-0 left-0 w-20 md:w-32 bg-gradient-to-r from-[#050508] to-transparent z-10 pointer-events-none" />
            <div className="absolute inset-y-0 right-0 w-20 md:w-32 bg-gradient-to-l from-[#050508] to-transparent z-10 pointer-events-none" />
